...
This section presents the results of the solutions together with an evaluation of the results and the project.  It should include information on experimental settings.  The results should demonstrate the claimed benefits/disadvantages of the proposed solutions.

This section should be between 3 to 5 pages in length.
...
IV. & Results and Evaluation & 3--5 \\ \hline
V. & Conclusions & 1 \\ \hline
\end{tabular}
\end{table}
